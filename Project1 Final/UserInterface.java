...
public class UserInterface {
    ...
    private void help() {
        String message = "Commands are:\n"
                ...
                + "[ " + ADD_ITEM_TO_CART + " ] to add item to shoppingcart\n"
                + "[ " + LIST_SHOPPINGCART + " ] to display shoppingcart\n"
    ...
    private void listShoppingcart(){
        Iterator shoppingcart = warehouse.getShoppingcart();
        System.out.println("ShoppingCart List:\n");
        while(shoppingcart.hasNext()){
            System.out.println(shoppingcart.next());
        }
    }
    /*
...
//			do{
				...
				System.out.println(name + productid + amt + price);
